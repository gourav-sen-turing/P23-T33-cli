...
def program(args: argparse.Namespace, env: Environment) -> ExitStatus:
    ...
    final_response = None
    for message in collect_messages(args=args, config_dir=env.config_dir):
    ...
    if final_response and args.check_status:
        exit_status = http_status_to_exit_status(final_response.status_code)
